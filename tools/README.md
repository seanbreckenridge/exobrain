...
- General Workflow/Tools
  ...
  - For basic image cropping, I use [`pinta`](https://www.pinta-project.com/). For general image manipulation tasks I create lots of small [`imagemagick`](https://imagemagick.org/index.php) scripts to do random resizes/converts. I have a larger script to [convert videos to gifs](https://sean.fish/d/gifme?redirect), and use [`gifsicle`](https://github.com/kohler/gifsicle) for manipulating gifs
  ...
  - For previewing markdown/latex while I'm editing it, I have my own [`compile`](https://sean.fish/d/compile?redirect) and [`live-render`](https://sean.fish/d/live-render?redirect) scripts
  ...
  - [`ix`](https://sean.fish/d/ix?redirect) to create pastebin links from the command line
